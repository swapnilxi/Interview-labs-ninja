...
import TemplateMultiSelect from './TemplateMultiSelect';
...
interface GeneratorPanelProps {
  /** Owned by the shell (LinkedInPostGeneratorModule) so both this panel and
   * the Templates tab's badge/count stay in sync without a page reload. */
  templates: LinkedInTemplate[];
  onTemplatesChanged: () => void;
  onManageTemplates: () => void;
}

export default function GeneratorPanel({ templates, onTemplatesChanged, onManageTemplates }: GeneratorPanelProps) {
