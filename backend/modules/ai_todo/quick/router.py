...
from ..tasks.db import create_task, get_all_tasks
...
def _get_ai_helpers():
    ...
    from ..shared.ai_helpers import call_ai as _call_ai, extract_json_array as _extract_json_array, call_vision_ai as _call_vision_ai, image_to_base64_jpeg as _image_to_base64_jpeg
